...
def main(id):
    id = 'https://music.163.com/#/song?id=%s'%str(id)
    id = idParse(id)
    ...
    if type == 'mp3':
        music = MP3(detail,name)
    elif type == 'flac':
        music = FLAC(detail,name)
...
if __name__ == '__main__':
    ...
    # id = 'https://music.163.com/#/song?id=1416662192'
    # id = 'https://music.163.com/#/song?id=448065'
